                ...
                Task.Factory.StartNew(() =>
                {
                    while (!cts.IsCancellationRequested)
                    {
                        try
                        {
                            ...
                            UserCacheDictionary.DomainUsrs.Add(cr.Message.Key, cr.Message.Value);
                            Console.WriteLine($"Id: {cr.Message.Key}, DomainName: {cr.Message.Value}, Last Update Datetime: {cr.Message.Timestamp}");
                        }
